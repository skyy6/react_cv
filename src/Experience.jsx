          ...
          <div className="experience-text-container">
            ...
            <div className="experience-text-description">
              <p>
                ...
                managing customer-specific functionality in the Public360
                system, using C# for integrations and MSSQL for database
                management.
              </p>
            </div>
          </div>
          ...
          <div className="experience-text-bottom-container">
            ...
            <div className="experience-text-description">
              <p>
                ...
                studies I was fortunate enough to be able to continue working
                here part-time.
              </p>
            </div>
          </div>
