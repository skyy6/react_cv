...
the basics of game development as well as how to use Unity on a basic level.</p>
  ...
  <div className='experience-text-container'>
        ...
        <div key={index}>
          ...
          <a className='underline' href={"https://github.com/" + item.repo.name + "/commit/" + item.payload.commits[0].sha} target='_blank'>
          {item.payload.commits[0].message} </a> {" in repo "} <a className='underline' href={"https://github.com/" + item.repo.name} target='_blank'>{"'" + item.repo.name.split("/")[1] + "'"}</a></p>
  ...
  <div className='exp-stack-container'>
    ...
    <div className='aboutme-stack-img-container'>
      <img src={csharp} className='aboutme-stack-img'></img>
      <img src={sql} className='aboutme-stack-img'></img>
      <img src={git} className='aboutme-stack-img'></img>
      <img src={html} className='aboutme-stack-img'></img>
      <img src={js} className='aboutme-stack-img'></img>
    </div>
  </div>
  </div>
  )
